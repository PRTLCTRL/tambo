...
For scenarios where you want _all_ generated components to be interactable without manually wrapping each one, you can enable automatic interactables on the `TamboProvider`:
