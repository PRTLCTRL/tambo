...
| `autoRegisterInteractables` | `boolean`                                        | No       | Automatically convert generated components to interactables for future updates (default: `false`) |
...
### Example with Auto-register Interactables

Enable `autoRegisterInteractables` to automatically convert all AI-generated components into interactables, allowing users to update previously-generated components through natural language:
...
When enabled, this allows workflows like:

1. User: "Show me a chart of Q4 sales"
2. AI generates a `SalesChart` component
3. User: "Update that chart to show Q3 instead"
4. AI updates the existing component rather than creating a new one

See the [Interactable Components guide](/concepts/generative-interfaces/interactable-components) for more details.
