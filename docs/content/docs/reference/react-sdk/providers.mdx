...
| `autoAddToInteractables`    | `boolean`                                        | No       | Automatically add all generated components to interactables (default: `false`). See [Automatic Interactables](/concepts/generative-interfaces/interactable-components#automatic-interactables) |
