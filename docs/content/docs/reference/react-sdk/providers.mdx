...
| `autoAddToInteractables`    | `boolean`                                        | No       | Automatically add all AI-generated components to the interactables registry, allowing the AI to update them in subsequent messages (default: `false`) |
