...
| `autoInteractables`         | `boolean`                                        | No       | Automatically register all AI-generated components as interactable, allowing the AI to update previously-generated components without explicit wrapping (default: `false`) |
