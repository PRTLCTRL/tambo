...
| `completedItems`  | `unknown[]` | For array props: items that have finished streaming. Only present when the prop is an array. |
| `streamingItems`  | `unknown[]` | For array props: items currently being streamed or pending. Only present when the prop is an array. |
