...
If you want *all* generated components to be automatically interactable without manually wrapping them, enable the `autoAddToInteractables` prop on `TamboProvider`:
