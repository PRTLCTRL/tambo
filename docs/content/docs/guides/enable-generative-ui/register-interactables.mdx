...
If you want _all_ generated components to be automatically interactable without manually wrapping them, enable the `autoAddToInteractables` prop on `TamboProvider`:
...
When enabled, any component that Tambo generates will be automatically registered as an interactable component, allowing Tambo to modify it in subsequent interactions. This is useful for:

- Dashboards where all displayed components should be editable
- Rapid prototyping scenarios
- When you want maximum flexibility without manual setup
