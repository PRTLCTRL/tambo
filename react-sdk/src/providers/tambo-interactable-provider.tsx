 ...
 * @param props.autoAddComponentsToInteractables - Whether to automatically register generated components as interactables
...
> = ({ autoAddComponentsToInteractables = false, children }) => {
  ...
  return (
    <TamboInteractableContext.Provider value={value}>
      <AutoAddEnabledContext.Provider value={autoAddComponentsToInteractables}>
        {children}
      </AutoAddEnabledContext.Provider>
    </TamboInteractableContext.Provider>
  );
};

/**
 * Context for passing down the auto-add setting to child components
 * @internal
 */
const AutoAddEnabledContext = createContext<boolean>(false);

/**
 * Hook to access the auto-add setting.
 * Used internally by TamboStreamProvider to enable automatic component registration.
 * @returns boolean indicating if auto-add is enabled
 */
export const useAutoAddEnabled = () => useContext(AutoAddEnabledContext);
