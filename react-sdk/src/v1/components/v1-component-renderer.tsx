...
export const ComponentRenderer: FC<ComponentRendererProps> = ({
  ...
  // Automatically add component to interactables if the feature is enabled
  useEffect(() => {
    if (
      !config.autoAddGeneratedComponentsToInteractables ||
    ...
    // Check if this component ID is already in interactables
    ...
    try {
      ...
      addInteractableComponent({
        name: content.name,
        description:
          registeredComponent.description ?? `${content.name} component`,
      ...
      console.warn(
        `[ComponentRenderer] Failed to add component ${content.name} to interactables:`,
        error,
      );
    }
  }, [
