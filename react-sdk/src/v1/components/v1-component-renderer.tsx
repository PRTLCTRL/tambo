...
export const ComponentRenderer: FC<ComponentRendererProps> = ({
  ...
  // Auto-add to interactables when streaming is done (if enabled)
  useEffect(() => {
    if (
      ...
      // Use a more specific check: look for components with this specific component ID
        ...
        if (registeredComponent) {
          addInteractableComponent({
            ...
            description:
              ...
              `Component ${content.name} generated by AI`,
