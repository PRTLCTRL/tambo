...
export interface TamboConfig {
  ...
  /**
   * Whether to automatically add all generated components to the interactables list.
   * When enabled, every component received in a message is automatically registered
   * as an interactable, allowing the AI to update it later without manual registration.
   * Defaults to false.
   */
 ...
 * @param props.autoInteractables - Whether to automatically add all generated components to interactables. Defaults to false.
