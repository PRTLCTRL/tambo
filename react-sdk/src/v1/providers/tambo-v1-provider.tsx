...
export interface TamboConfig {
   ...
   * allowing them to be updated by future AI messages. Defaults to false.
   */
 ...
 * @param props.autoInteractables - When true, all AI-generated components are automatically added to interactables. Defaults to false.
