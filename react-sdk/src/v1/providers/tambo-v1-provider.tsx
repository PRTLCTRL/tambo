...
export interface TamboConfig {
   ...
   * When enabled, any component generated by the AI will be automatically added
   * to the interactables list, allowing the AI to update them later.
   * Defaults to false.
   */
 ...
 * @param props.autoRegisterInteractables - Whether to automatically register generated components as interactables. Defaults to false.
