...
export interface TamboConfig {
   ...
   * When enabled, any component generated by the AI will automatically be added
   * as an interactable component, allowing it to be updated via subsequent messages.
   * Defaults to false.
   */
