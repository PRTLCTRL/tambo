...
import { TamboAutoInteractablesManager } from "./tambo-v1-auto-interactables";
...
> {
  ...
  /**
   * Whether to automatically add generated components to the interactables list.
   * When enabled, every component the AI generates becomes interactable, allowing
   * users to update previously-generated components through natural language.
   * Defaults to false.
   */
  autoInteractables?: boolean;
 ...
 * @param props.autoInteractables - Whether to automatically add generated components to interactables. Defaults to false.
