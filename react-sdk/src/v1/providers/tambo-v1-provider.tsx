...
export interface TamboConfig {
   ...
   * When enabled, all components received in messages are automatically registered
   * as interactable components, allowing them to be updated via AI interactions.
   * Defaults to false.
   */
