...
export interface TamboConfig {
   ...
   * This allows the AI to update previously generated components without explicit interactable registration.
   * Defaults to false.
   */
 ...
 * @param props.autoInteractables - When enabled, automatically add all AI-generated components to the interactables list. Defaults to false.
