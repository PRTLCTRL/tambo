...
> {
   ...
   * When enabled, any component generated by the AI will be automatically tracked
   * as an interactable component, allowing it to be updated through natural language.
   * Defaults to false.
   */
 ...
 * @param props.autoInteractables - Whether to automatically add generated components to the interactables list. Defaults to false.
