...
export interface TamboConfig {
   ...
   * as an interactable, allowing the AI to update it in subsequent requests.
   * Defaults to false.
   */
 ...
 * @param props.autoAddToInteractables - Automatically add all generated components to interactables. Defaults to false.
