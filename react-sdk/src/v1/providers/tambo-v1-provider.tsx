...
export interface TamboConfig {
  ...
  /**
   * When enabled, all generated components are automatically added to interactables.
   * This allows the AI to update previously-generated components without explicit withTamboInteractable wrapping.
   * Defaults to false.
   */
 ...
 * @param props.autoAddToInteractables - When enabled, all generated components are automatically added to interactables. Defaults to false.
