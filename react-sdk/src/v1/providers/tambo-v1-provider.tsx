...
export interface TamboConfig {
   ...
   * This allows the AI to update previously-generated components rather than creating new ones.
   * Defaults to false.
   */
 ...
 * @param props.autoAddComponentsToInteractables - When enabled, all AI-generated components are automatically added to the interactables registry. Defaults to false.
            ...
            <TamboMcpProvider>
              <TamboContextAttachmentProvider>
                <TamboInteractableProvider
                  autoAddComponents={autoAddComponentsToInteractables}
                >
