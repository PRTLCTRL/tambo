...
export interface TamboConfig {
  ...
  /**
   * When enabled, all generated components are automatically added to the interactables list,
   * allowing them to be updated by the AI. Defaults to false.
   */
 ...
 * @param props.autoInteractable - When enabled, all generated components are automatically added to interactables. Defaults to false.
