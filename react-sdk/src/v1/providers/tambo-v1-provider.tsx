...
export interface TamboConfig {
   ...
   * This allows the AI to update previously generated components instead of creating new ones.
   * Defaults to false.
   */
 ...
 * @param props.autoAddComponentsToInteractables - When enabled, automatically adds all generated components to the interactables registry. Defaults to false.
