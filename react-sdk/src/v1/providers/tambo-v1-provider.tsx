...
export interface TamboConfig {
   ...
   * When enabled, all components generated by the AI are automatically added to the interactable components list,
   * allowing them to be updated in subsequent interactions.
   * Defaults to false.
   */
