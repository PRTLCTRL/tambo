...
export interface TamboConfig {
   ...
   * When enabled, any component received in an assistant message is automatically
   * registered as an interactable, allowing it to be updated via future messages.
   * Defaults to false.
   */
