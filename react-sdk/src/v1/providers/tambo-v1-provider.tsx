...
export interface TamboConfig {
  ...
  /**
   * Automatically add generated components to interactables.
   * When enabled, any component generated by the AI is automatically added
   * to the interactable components list.
   * Defaults to false.
   */
...
> {
   ...
   * Automatically add generated components to interactables.
   * When enabled, any component generated by the AI is automatically added
   * to the interactable components list, allowing it to be updated in subsequent messages.
   * Defaults to false.
   */
  autoAddComponentsToInteractables?: boolean;
