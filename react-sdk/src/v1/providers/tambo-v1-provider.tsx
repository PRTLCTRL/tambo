...
export interface TamboConfig {
   ...
   * When enabled, every component generated by the AI is automatically made interactable.
   * Defaults to false.
   */
...
> {
   ...
   * Whether to automatically add all generated components to the interactables registry.
   * When enabled, every component generated by the AI is automatically made interactable,
   * allowing the AI to update them in response to future user requests.
   * Defaults to false.
   */
  autoAddInteractables?: boolean;
 ...
 * @param props.autoAddInteractables - Whether to automatically add all generated components to interactables. Defaults to false.
