...
export interface TamboConfig {
   ...
   * This allows the AI to update previously-generated components instead of always creating new ones.
   * Defaults to false.
   */
 ...
 * @param props.autoAddComponentsToInteractables - When enabled, all generated components are automatically added to interactables. Defaults to false.
