...
export interface TamboConfig {
  ...
  /**
   * When enabled, all generated components are automatically registered as interactables.
   * This allows users to reference and update previously-generated components via natural language.
   * Defaults to false.
   */
 ...
 * @param props.autoAddComponentsToInteractables - When enabled, automatically register all generated components as interactables. Defaults to false.
