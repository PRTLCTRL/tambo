...
export interface TamboConfig {
  ...
  /**
   * Automatically add AI-generated components to the interactables registry.
   * When enabled, any component generated by the AI will be added to the interactables list,
   * allowing the AI to modify it in subsequent interactions.
   * Defaults to false.
   */
  autoAddGeneratedComponentsToInteractables?: boolean;
}
 ...
 * @param props.autoAddGeneratedComponentsToInteractables - Automatically add AI-generated components to interactables registry. Defaults to false.
...
export function TamboProvider({
  ...
  initialMessages,
  autoAddGeneratedComponentsToInteractables,
  children,
