...
export interface TamboConfig {
  ...
  /**
   * Whether to automatically add all AI-generated components to the interactables list.
   * When enabled, every component rendered by the AI becomes interactive and can be updated.
   * Defaults to false.
   */
 ...
 * @param props.autoAddComponentsToInteractables - Whether to automatically add AI-generated components to interactables. Defaults to false.
