...
export interface TamboConfig {
   ...
   * When enabled, every component rendered in messages is automatically registered as interactable,
   * allowing the AI to update them later. Defaults to false.
   */
 ...
 * @param props.autoInteractables - Whether to automatically add all generated components to the interactables list. Defaults to false.
